...
SET LOG=Search ARC
::
	IF EXIST "%programfiles%\%ARC_FOLDER%\%ARC_EXE%" SET "ARC_PATH=%programfiles%\%ARC_FOLDER%" 
	IF EXIST "%programfiles(x86)%\%ARC_FOLDER%\%ARC_EXE%" SET "ARC_PATH=%programfiles(x86)%\%ARC_FOLDER%" 
